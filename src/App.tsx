        ...
        <aside className='w-80 space-y-6'>
          ...
          <form className='space-y-6'>
            ...
            <div className='space-y-4'>
              ...
              <span className='block text-xs text-muted-foreground italic leading-relaxed'>Higher values tend to return more creative results, but with possible errors.</span>
            </div>
